...
(SEC-06), so a factory that hashed per row would charge that cost to every test that needs a
...
# something else; the ones that assert case sensitivity use this in upper case (RF-15).
