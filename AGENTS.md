...
- transversal sin dominio (engine y sesión, `DomainError`, el límite de intentos, Argon2, JWT, `get_current_user`, las tareas de fondo) → `app/` (`db.py` · `errors.py` · `ratelimit.py` · `security.py` · `tasks.py`)
