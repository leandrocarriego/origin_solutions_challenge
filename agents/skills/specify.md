...
- **Nada que contradiga las reglas del dominio** (`CONSTITUTION.md`, artículos I, II, III y VII).
...
1. Leer `docs/PROJECT_BRIEF.md`. Nombrar los requisitos del enunciado que la feature cubre
   (`REQ-05`, …) y reusar el vocabulario del cliente, no uno nuevo. Leer también sus
   **Ambigüedades declaradas** (`A1`…`A7`): lo que ahí ya está resuelto se respeta, y lo que la
   feature abre y nadie resolvió se arrastra a la spec como `[NECESITA ACLARACIÓN: …]` en vez de
   resolverse suponiendo (Artículo VII).
...
3. Elegir el slug: dos o tres palabras, kebab-case, **en inglés** y sin tildes
   (`001-authentication`). El contenido va en español; sólo el nombre va en inglés.
